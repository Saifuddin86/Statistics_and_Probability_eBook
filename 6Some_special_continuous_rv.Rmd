...
**Solution of f.** Since T is exponentially distributed and hold lack of memory property, so it dose not matter what was happened in past 3 seconds. We have to just compute that *there will be an emission (event will occur) within the next second*. So,
...
-   $P(Z\le 1.5)=\Phi(1.5)=$`r round(pnorm(1.5),4)`
